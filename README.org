...
** TODO add jql: search support
   :LOGBOOK:
   - State "TODO"       from              [2024-09-08 Sun 12:55]
   :END:
** WORKING Voting screen [5/10] [50%]
   :LOGBOOK:
...
** TODO check logged in state (when in ~/app~) and other statuses (because currenly it allows to see ~/app/~
   :LOGBOOK:
   - State "TODO"       from "REVIEW"     [2024-09-15 Sun 08:45]
   - State "REVIEW"     from              [2024-09-15 Sun 08:45]
   :END:

 - make 'sync' / 'status' query.
 - make sure ws is working

** TODO Websocket coordination [2/7]
   :LOGBOOK:
   CLOCK: [2024-09-15 Sun 10:05]
