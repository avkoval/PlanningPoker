...
** DONE use iframe for docs part
   ...
   :END:
** TODO Search for ticket (Estimate ticket screen) [13/17]             :verb:
   :LOGBOOK:
 ...
 - [X] implement same structure (as for saving comment) for searching after delay only! user need to stop typing to see results!
