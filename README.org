...
#+begin_src plantuml :file static/img/process1.png
@startuml
actor Facilitator
...
*** DONE update docs for planner poker rules
    ...
    :END:
*** TODO fix error of websocket over https/http on pp.ngrok.dev
    :LOGBOOK:
    - State "TODO"       from              [2025-04-29 Tue 08:00]
    :END:

*** TODO auto reconnect for web socket
    :LOGBOOK:
...
*** TODO comment as jira user
    :LOGBOOK:
    - State "TODO"       from              [2025-04-27 Sun 21:10]
    :END:

*** TODO display avatars of logged in users
    :LOGBOOK:
    - State "TODO"       from              [2025-04-27 Sun 21:10]
    :END:
...
*** TODO Show icons of online users dynamically and with Jira/Google auth icon
    :LOGBOOK:
